...
public class Main{
    ...
    public static Node createLeftClone(Node node){
        ...
        Node nln = new Node(node.data, lcr, null);
        node.left = nln;
        node.right =  rcr;
    ...
    public static Node backFromLeftClone(Node node){
        if(node == null){
            return null;
        }
        
        Node lcr = backFromLeftClone(node.left.left);
        Node rcr = backFromLeftClone(node.right);
