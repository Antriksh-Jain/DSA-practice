...
public class Main{
    ...
    public static void main(String[] args){
        ...
        for(int i=0; i<n2; i++){
            int d2 = Integer.parseInt(val2.split(" ")[i]);
            l2.addLast(d2);
        }
        ...
        for(int i=0; i<n3; i++){
            int d = Integer.parseInt(val3.split(" ")[i]);
            common.addLast(d);
        }
        
        l1.tail.next = common.head;
        l1.tail = common.tail;
        
        l2.tail.next = common.head;
        l2.tail = common.tail;
        
        
        int ins = LinkedList.findIntersection(l1, l2);
